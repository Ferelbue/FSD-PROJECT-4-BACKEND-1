...
// DONE puede modificar su nombre, apellido y email.
...
// DONE TODAS LAS CITAS DEL USUARIO REGISTRADO 
app.get('/api/appointments/:id', 
auth, getAppointment) // DONE UNA CITA DICIENDO ID DE LA CITA Un user solo puede ver sus citas. Admin o super las citas de todos (una a una)
app.post('/api/appointments', auth, isAdmin, createAppointment) // DONE
app.put('/api/appointments', auth, updateAppointment) 
// DONE LE PASAS EL ID DE LA CITA QUE QUIERES MODIFICAR, LA NUEVA FECHA Y LA HORA. Un usuario solo puede modificar sus citas. Un admin y un super pueden modificar las todas las citas.
